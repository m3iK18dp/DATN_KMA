          ...
          <div style="margin: 10px auto; width: 600px">
            ...
            <div style="margin: 5px">
             ...
             <div style="margin: 5px">
              ...
              <span style="display: inline-block; font-family: 'Times New Roman'; font-size: 20px">:</span>
              <span style="display: inline-block; padding-left: 20px; font-size: 20px;  font-family: 'Times New Roman'; color:${
                styleType[transaction.transactionType]
            ...
            <div style="margin: 5px">
              <span style="display: inline-block; width: 170px; font-weight: bold; font-family: 'Times New Roman'; font-size: 20px; font-style: italic">${
            ...
            <div style="margin: 5px">
              ...
              <span style="display: inline-block; font-family: 'Times New Roman'; font-size: 20px">:</span>
              <span style="display: inline-block; padding-left: 20px; font-size: 20px;  font-family: 'Times New Roman'; color:${
                transaction.transactionStatus === "SUCCESS" ? "green" : "red"
        ...
        <div>
          ...
          <div style="margin: 10px 10px 10px 20%">
            ...
            <div style="margin: 5px">
              ...
              <span style="display: inline-block; font-family: 'Times New Roman'; font-size: 20px; ${
                transaction.transactionCode !==
                changedTransaction.transactionCode
                  ? "color: red"
                  : ""
