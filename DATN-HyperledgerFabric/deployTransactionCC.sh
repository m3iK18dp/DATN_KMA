...
setGlobalsForPeer1Org1() {
    ...
    export CORE_PEER_MSPCONFIGPATH=${PWD}/artifacts/channel/crypto-config/peer1rganizations/org1.example.com/users/Admin@org1.example.com/msp
...
setGlobalsForPeer1Org2() {
    ...
    export CORE_PEER_MSPCONFIGPATH=${PWD}/artifacts/channel/crypto-config/peer1rganizations/org2.example.com/users/Admin@org2.example.com/msp
...
presetup() {
    ...
    pushd ./artifacts/src/transaction
...
VERSION="1"
SEQUENCE="1"
CC_SRC_PATH="./artifacts/src/transaction"
