createcertificatesForOrg1() {
 ...
 # -----------------------------------------------------------------------------------
  #  Peer 1
  mkdir -p ../new-certs/peer1rganizations/org1.example.com/peers/peer1.org1.example.com

  echo
  echo "## Generate the peer1 msp"
  echo
  fabric-ca-client enroll -u https://peer1:peer1pw@localhost:7054 --caname ca.org1.example.com -M ${PWD}/../new-certs/peer1rganizations/org1.example.com/peers/peer1.org1.example.com/msp --csr.hosts peer1.org1.example.com --tls.certfiles ${PWD}/fabric-ca/org1/tls-cert.pem

  cp ${PWD}/../new-certs/peer1rganizations/org1.example.com/msp/config.yaml ${PWD}/../new-certs/peer1rganizations/org1.example.com/peers/peer1.org1.example.com/msp/config.yaml

  echo
  echo "## Generate the peer1-tls certificates"
  echo
  fabric-ca-client enroll -u https://peer1:peer1pw@localhost:7054 --caname ca.org1.example.com -M ${PWD}/../new-certs/peer1rganizations/org1.example.com/peers/peer1.org1.example.com/tls --enrollment.profile tls --csr.hosts peer1.org1.example.com --csr.hosts localhost --tls.certfiles ${PWD}/fabric-ca/org1/tls-cert.pem

  cp ${PWD}/../new-certs/peer1rganizations/org1.example.com/peers/peer1.org1.example.com/tls/tlscacerts/* ${PWD}/../new-certs/peer1rganizations/org1.example.com/peers/peer1.org1.example.com/tls/ca.crt
  cp ${PWD}/../new-certs/peer1rganizations/org1.example.com/peers/peer1.org1.example.com/tls/signcerts/* ${PWD}/../new-certs/peer1rganizations/org1.example.com/peers/peer1.org1.example.com/tls/server.crt
  cp ${PWD}/../new-certs/peer1rganizations/org1.example.com/peers/peer1.org1.example.com/tls/keystore/* ${PWD}/../new-certs/peer1rganizations/org1.example.com/peers/peer1.org1.example.com/tls/server.key

  mkdir ${PWD}/../new-certs/peer1rganizations/org1.example.com/msp/tlscacerts
  cp ${PWD}/../new-certs/peer1rganizations/org1.example.com/peers/peer1.org1.example.com/tls/tlscacerts/* ${PWD}/../new-certs/peer1rganizations/org1.example.com/msp/tlscacerts/ca.crt

  mkdir ${PWD}/../new-certs/peer1rganizations/org1.example.com/tlsca
  cp ${PWD}/../new-certs/peer1rganizations/org1.example.com/peers/peer1.org1.example.com/tls/tlscacerts/* ${PWD}/../new-certs/peer1rganizations/org1.example.com/tlsca/tlsca.org1.example.com-cert.pem

  mkdir ${PWD}/../new-certs/peer1rganizations/org1.example.com/ca
  cp ${PWD}/../new-certs/peer1rganizations/org1.example.com/peers/peer1.org1.example.com/msp/cacerts/* ${PWD}/../new-certs/peerOrganizations/org1.example.com/ca/ca.org1.example.com-cert.pem
}
...
createCertificatesForOrg2() {
  ...
  # --------------------------------------------------------------
  # Peer 0 
  mkdir -p ../new-certs/peerOrganizations/org2.example.com/peers/peer1.org2.example.com
  echo
  echo "## Generate the peer1 msp"
  echo
   
  fabric-ca-client enroll -u https://peer1:peer1pw@localhost:8054 --caname ca.org2.example.com -M ${PWD}/../new-certs/peerOrganizations/org2.example.com/peers/peer1.org2.example.com/msp --csr.hosts peer1.org2.example.com --tls.certfiles ${PWD}/fabric-ca/org2/tls-cert.pem
   

  cp ${PWD}/../new-certs/peerOrganizations/org2.example.com/msp/config.yaml ${PWD}/../new-certs/peerOrganizations/org2.example.com/peers/peer1.org2.example.com/msp/config.yaml

  echo
  echo "## Generate the peer1-tls certificates"
  echo
   
  fabric-ca-client enroll -u https://peer1:peer1pw@localhost:8054 --caname ca.org2.example.com -M ${PWD}/../new-certs/peerOrganizations/org2.example.com/peers/peer1.org2.example.com/tls --enrollment.profile tls --csr.hosts peer1.org2.example.com --csr.hosts localhost --tls.certfiles ${PWD}/fabric-ca/org2/tls-cert.pem
   

  cp ${PWD}/../new-certs/peerOrganizations/org2.example.com/peers/peer1.org2.example.com/tls/tlscacerts/* ${PWD}/../new-certs/peerOrganizations/org2.example.com/peers/peer1.org2.example.com/tls/ca.crt
  cp ${PWD}/../new-certs/peerOrganizations/org2.example.com/peers/peer1.org2.example.com/tls/signcerts/* ${PWD}/../new-certs/peerOrganizations/org2.example.com/peers/peer1.org2.example.com/tls/server.crt
  cp ${PWD}/../new-certs/peerOrganizations/org2.example.com/peers/peer1.org2.example.com/tls/keystore/* ${PWD}/../new-certs/peerOrganizations/org2.example.com/peers/peer1.org2.example.com/tls/server.key

  mkdir ${PWD}/../new-certs/peerOrganizations/org2.example.com/msp/tlscacerts
  cp ${PWD}/../new-certs/peerOrganizations/org2.example.com/peers/peer1.org2.example.com/tls/tlscacerts/* ${PWD}/../new-certs/peerOrganizations/org2.example.com/msp/tlscacerts/ca.crt

  mkdir ${PWD}/../new-certs/peerOrganizations/org2.example.com/tlsca
  cp ${PWD}/../new-certs/peerOrganizations/org2.example.com/peers/peer1.org2.example.com/tls/tlscacerts/* ${PWD}/../new-certs/peerOrganizations/org2.example.com/tlsca/tlsca.org2.example.com-cert.pem

  mkdir ${PWD}/../new-certs/peerOrganizations/org2.example.com/ca
  cp ${PWD}/../new-certs/peerOrganizations/org2.example.com/peers/peer1.org2.example.com/msp/cacerts/* ${PWD}/../new-certs/peerOrganizations/org2.example.com/ca/ca.org2.example.com-cert.pem
}
